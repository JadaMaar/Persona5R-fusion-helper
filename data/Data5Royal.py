...
arcana2CombosRoyal = [
    ...
    {'source': ['Empress', 'Councillor'], 'result': 'Hanged Man'},
    ...
    {'source': ['Lovers', 'Hanged Man'], 'result': 'Councillor'},
    ...
    {'source': ['Justice', 'Faith'], 'result': 'Hanged Man'},
    ...
    {'source': ['Hanged Man', 'Moon'], 'result': 'Councillor'},
    {'source': ['Hanged Man', 'Sun'], 'result': 'Hierophant'},
    {'source': ['Hanged Man', 'Judgement'], 'result': 'Star'},
    {'source': ['Hanged Man', 'Faith'], 'result': 'Devil'},
    {'source': ['Hanged Man', 'Councillor'], 'result': 'Star'},
...
specialCombosRoyal = [
    ...
    {"result": 'Izanagi-no-Okami Picaro',
     "sources": ["Okuninushi", "Orthrus", "Kali", "Mithras", "Cu Chulainn", "Lucifer"]},
